		    ...
		    <div class="modal-content">
		      ...
		      <div class="modal-body">
		        <form action="processbarang.php?do=add" method="POST" id="formbarang">
		        	...
		        	<div class="form-group row">
		        		<label for="namabarang" class="col-sm-4 col-form-label">Nama Bengkel</label>
		        		<div class="col-sm-8">
		        			<input type="text" class="form-control" placeholder="Nama Bengkel" id="workshop_name" name="workshop_name">
		        		</div>
		        	</div>
                ...
                <!-- Kodingan Satuan Quantity Masuk -->
		        	<div class="form-group row">
		        		<label for="satuanbarang" class="col-sm-4 col-form-label">Satuan Barang</label>
		        		<div class="col-sm-8">
		        			<input type="text" class="form-control" placeholder="Satuan Barang" id="satuanbarang" name="satuanbarang">
		        		</div>
		        	</div>
                ...
                <!-- Kodingan Keterangan Masuk -->
                    <div class="form-group row">
		        		<label for="information" class="col-sm-4 col-form-label">Keterangan</label>
		        		<div class="col-sm-8">
		        			<input type="text" class="form-control" placeholder="Keterangan" id="information" name="information">
		        		</div>
		        	</div>
		    ...
		    <div class="modal-content">
		      ...
		      <div class="modal-body">
		        <form action="processmutasi.php?do=add" method="POST" id="formmutasiform">
                    ...
                    <div class="form-group row">
		        		<label for="namabengkelmutasi" class="col-sm-4 col-form-label">Nama Bengkel</label>
		        		<div class="col-sm-8">
		        			<input type="text" class="form-control" placeholder="Nama Bengkel" id="namabengkelmutasi" name="namabengkelmutasi">
		        		</div>
                    </div>

                    <!-- Ini Kodingan Nama Barang Keluar -->
                    <div class="form-group row">
		        		<label for="namabarangkeluarmutasi" class="col-sm-4 col-form-label">Nama Barang Keluar</label>
		        		<div class="col-sm-8">
		        			<input type="text" class="form-control" placeholder="Nama Barang Keluar" id="namabarangkeluarmutasi" name="namabarangkeluarmutasi">
		        		</div>
                    </div>
		        	...
		        	<div class="form-group row">
		        		<label for="satuanbarangkeluar" class="col-sm-4 col-form-label">Satuan Barang</label>
		        		<div class="col-sm-8">
		        			<input type="text" class="form-control" placeholder="Satuan Barang" id="satuanbarangkeluar" name="satuanbarangkeluar">
		        		</div>
		        	</div>

                    <!-- Ini Kodingan Keterngan Mutasi -->
		        	<div class="form-group row">
		        		<label for="keteranganmutasi" class="col-sm-4 col-form-label">Keterangan Mutasi</label>
		        		<div class="col-sm-8">
		        			<input type="text" class="form-control" placeholder="Keterangan Mutasi" id="keteranganmutasi" name="keteranganmutasi">
		        		</div>
		        	</div>
		      </div>
