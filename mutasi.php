		    ...
		    <div class="modal-content">
		      ...
		      <div class="modal-body">
		        <form action="processbarang.php?do=add" method="POST">
		        	...
		        	<div class="form-group row">
		        		<label for="namabengkel" class="col-sm-4 col-form-label">Nama Bengkel</label>
		        		<div class="col-sm-8">
		        			<input type="text" class="form-control" placeholder="Nama Bengkel" id="namabengkel" name="namabengkel">
		        		</div>
		        	</div>
		        	...
		        	<div class="form-group row">
		        		<label for="keterangankeluar" class="col-sm-4 col-form-label">Keterangan</label>
		        		<div class="col-sm-8">
		        			<input type="text" class="form-control" placeholder="Nama Barang" id="keterangankeluar" name="keterangankeluar">
		        		</div>
		        	</div>
